...
class SuggestedActivitiesScreen extends StatelessWidget {
  ...
  const SuggestedActivitiesScreen({Key? key, required this.totalScore})
      : super(key: key);
                        ...
                        children: [
                          ...
                          ClipRRect(
                            borderRadius: BorderRadius.circular(
                                12.0), // Match the container's corner radius
                            child: Image.asset(
                              'assets/images/voca.jpg', // Replace with your image path
                              fit: BoxFit.cover,
                              width: double.infinity, // Ensures full width
                              height:
                                  150.0, // Set a specific height for the image
                            ),
                          ),
                          const SizedBox(
                              height: 16.0), // Space between image and text
                          Text(
                          ...
                          if (totalScore >= 95) ...[
                            Text("- Explore advanced vocabulary exercises.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Try challenging word puzzles.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Mentor someone in vocabulary building.",
                                style: const TextStyle(fontSize: 16)),
                          ] else if (totalScore >= 75) ...[
                            Text(
                                "- Practice daily quizzes to maintain your streak.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Read more advanced articles or books.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Join a vocabulary challenge group.",
                                style: const TextStyle(fontSize: 16)),
                          ] else if (totalScore >= 60) ...[
                            Text("- Work on improving commonly missed words.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Solve moderate-level vocabulary puzzles.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Set a weekly vocabulary improvement goal.",
                                style: const TextStyle(fontSize: 16)),
                          ] else if (totalScore >= 30) ...[
                            Text("- Start with basic vocabulary-building apps.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Practice flashcards for new words daily.",
                                style: const TextStyle(fontSize: 16)),
                            Text(
                                "- Read simple articles and highlight new words.",
                                style: const TextStyle(fontSize: 16)),
                          ] else ...[
                            Text(
                                "- Begin with foundational word-building exercises.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Use picture-based vocabulary tools.",
                                style: const TextStyle(fontSize: 16)),
                            Text("- Try speaking aloud to enhance retention.",
                                style: const TextStyle(fontSize: 16)),
                          ],
                        ],
                      ),
