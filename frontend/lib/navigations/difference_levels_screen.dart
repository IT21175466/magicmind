...
import 'package:magicmind_puzzle/navigations/difference_find_screen.dart';
import 'package:magicmind_puzzle/navigations/home_screen.dart';
import 'package:magicmind_puzzle/navigations/previous_difference_records_screen.dart';
...
class _DemoVideoPlayerState extends State<DemoVideoPlayer> {
  ...
  void initState() {
    super.initState();
    _controller =
        VideoPlayerController.asset("assets/videos/difference-demo.mp4")
          ..initialize().then((_) {
            setState(() {});
            _controller.play();
          });
