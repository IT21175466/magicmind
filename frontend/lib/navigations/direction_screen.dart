...
class _DirectionScreenState extends State<DirectionScreen> {
  ...
  void initState() {
    ...
    hint = widget.levelData['clue'] ??
        "Find the correct direction"; // Set initial hint
  }
  ...
  Future<void> generateImageFromPrompt() async {
    ...
    final payload = {
      "prompt": widget.levelData['answer'] ??
  ...
  void _checkAnswers() async {
    ...
    List<String> correctPrepositions =
        widget.levelData['answer']?.split(' ') ?? [];
          ...
          TextButton(
            onPressed: () async {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (context) => DirectionLevelsScreen()),
              );
            },
