...
import 'package:magicmind_puzzle/navigations/difference_identification_preformance_screen.dart'
    as vocabScreen;
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 10),
            Text(
                "Current Vocabulary Level: ${_getGrade(difficulty)} (Difficulty $difficulty)",
                style: TextStyle(fontSize: 16)),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (context) =>
                          vocabScreen.VocabularyPerformanceScreen()),
                );
              },
