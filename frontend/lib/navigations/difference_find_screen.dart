...
import 'package:magicmind_puzzle/navigations/difference_find_results_screen.dart';
...
class _DifferenceFindScreenState extends State<DifferenceFindScreen> {
  ...
  void initState() {
    ...
    secondMissingObjectIndex = random.nextInt(
        widget.levelData["objects"].length - 1); // Ensure different indices
  ...
  void _showStatsPopup() {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title:
            const Text("Game Stats", style: TextStyle(color: Colors.white70)),
        content: Text(
                    ...
                    child: Padding(
                      ...
                      child: Stack(
                        children: [
                          ...
                          // Draggable objects
                          for (int i = 0;
                              i < widget.levelData["objects"].length;
                              i++)
                            Positioned(
                              ...
                              child: Draggable<int>(
                                ...
                                onDragEnd: (details) {
                                  ...
                                  setState(() {
                                    dragMoves++;
                                    audioPlayer
                                        .play(AssetSource('audios/normal.mp3'));
                                    if ((i == missingObjectIndex ||
                                            i == secondMissingObjectIndex) &&
                                        details.offset.dy >
                                      ...
                                      audioPlayer.play(
                                          AssetSource('audios/success.mp3'));

                                      if (correctlyIdentifiedObjects
                                              .contains(missingObjectIndex) &&
                                          correctlyIdentifiedObjects.contains(
                                              secondMissingObjectIndex)) {
                                        audioPlayer.play(
                                            AssetSource('audios/success.mp3'));
                                        isCorrect = true;
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          height: MediaQuery.of(context).size.width *
                              0.1, // Optional: make it square for perfect centering
                          child: ElevatedButton(
                            style: ElevatedButton.styleFrom(
                              elevation: 3, // Slight elevation
                              backgroundColor:
                                  Color(0xff80ca84), // Button color
                              shape: RoundedRectangleBorder(
                                borderRadius:
                        ...
                        SizedBox(
                            width: 8), // Space between button and container
                        ...
                        Expanded(
                          child: Container(
                            ...
                            margin: const EdgeInsets.symmetric(
                                vertical: 16.0), // Optional for spacing
                            padding: const EdgeInsets.all(
                                12.0), // Padding inside the box
                            decoration: BoxDecoration(
                              color:
                                  Color(0xff27a5c6), // Transparent background
                              border: Border.all(
                            ...
                            child: Center(
                              child: Text(
                                ...
                                style: TextStyle(
                                  color:
                                      isCorrect ? Colors.white : Colors.white60,
                                  fontSize: 18.0,
                                  fontWeight: FontWeight.bold,
                                ),
